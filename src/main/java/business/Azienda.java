...
public class Azienda extends Utente {
    ...
    private Date dataIscrione, dataTermine;
    ...
    /*NEW AZIENDA API*/
    public Azienda(String username, String password, String email, String tipo, String nomR, String cognR, String telResp, String nomeResp, String cognResp, String emailResp, String ragSoc, String ind, String piva, String foro, String cap, String citta, String pro, Date dt) {
        this.username=username;
        this.password=password;
        this.email=email;
        this.tipo=tipo;
    ...
    public Date getDataIscrione() {
        return dataIscrione;
    }

    public void setDataIscrione(Date dataIscrione) {
